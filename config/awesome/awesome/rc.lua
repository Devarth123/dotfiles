...
-- local cpu_graph = require("awesome-wm-widgets.cpu-widget.cpu-widget")
...
--ooooooooooooooooooooooooooooooooooooooh my GOD
    -- Create the wibox
--    vicious.activate(memwidget)
        ...
        widget   = {
            ...
            { -- Right widgets
                ...
                
                {
                    layout = wibox.layout.align.horizontal,
                    ram_widget(),
		            wibox.container.margin(wibox.widget.textbox("|"), 5, 5, 0, 0),
                },
		        {
                ...
                {
                    	layout = wibox.layout.align.horizontal,
						battery_widget({show_current_level = true, font = "Caskaydia Cove Nerd Font 9", warning_msg_title = "Plug in charger now!", warning_msg_text = "Battery under 15%!"}),
						wibox.container.margin(wibox.widget.textbox("|"), 5, 5, 0, 0),
...
-- vicious.register(batwidget, vicious.widgets.bat, "$2", 61, "BAT0")-- memwidget = wibox.widget.textbox()
-- vicious.cache(vicious.widgets.mem)
-- vicious.register(memwidget, vicious.widgets.mem, "$1 ($2MiB/$3MiB)", 13)
